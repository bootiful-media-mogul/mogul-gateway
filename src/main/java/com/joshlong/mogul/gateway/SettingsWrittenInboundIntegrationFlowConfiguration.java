...
// todo why is this required? if i don't have it,
//      this {@code IntegrationFlow} doens't trigger
@EnableIntegration
@Configuration
class SettingsWrittenInboundIntegrationFlowConfiguration {
	...
	IntegrationFlow settingsWrittenInboundIntegrationFlow(ObjectMapper objectMapper,
			MogulSettingsAwareReactiveClientRegistrationRepository registrationRepository,
